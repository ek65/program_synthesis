...
behavior CoachBehavior():
    ...
    # Call for the pass as we move into position
    do Speak("Call for teammate to pass the ball while moving to target position")
    do MoveTo(λ_target0(), True)
    # Once we finish moving, just wait to receive ball
